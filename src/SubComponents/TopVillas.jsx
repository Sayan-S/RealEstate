...
const TopVillas = () => {
  return (
    <section id="topVillas">
      ...
      <p>
        Discover our top pick villa, nestled in the heart of nature. Offering
        luxurious amenities, a private pool, and breathtaking views, it's the
        perfect escape for relaxation. Enjoy spacious rooms, modern interiors,
        and easy access to local attractions. Your dream vacation awaits!
      </p>
